...
/////////////////////////////
    ...
    public class Texture {
        ...
        public Texture(final int p, final float zBuffer, final float a, final Screen s) {
            init = false;
            name = "Irij";
            this.path = p;
            this.z = zBuffer;
            ...
            currentScreen.gameSurfaceView.renderer.act(new Runnable(){
                @Override
                public void run() {
                    textureGL = new TextureGL(p, zBuffer, a, s);
                    init = true;
    ...
    public class TextureGL{
        ...
        public TextureGL(int p, float zBuffer, float a, Screen s) {
            ...
            this.img = BitmapFactory.decodeResource(
                    activity.getResources(), R.drawable.elli_walk, options);
